...
---
<img src="{{'/assets/figures/providence2.jpg' | absolute_url}}" height="100%" width="100%" alt="Children at Cascade School for the Deaf"/> 
...
<img src="{{'/assets/figures/providence.jpg' | absolute_url}}" height="100%" width="100%" alt="Children at Cascade School for the Deaf"/> 
...
{% include gallery.html collection='deafcaribbeanhistories' field='location' value='Providence' num_column=2 %}

<img src="{{'/assets/figures/providence3.jpg' | absolute_url}}" height="100%" width="100%" alt="Children at Cascade School for the Deaf"/> 
